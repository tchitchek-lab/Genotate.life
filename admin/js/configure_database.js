function database_reset() {
    ...
    if (db_name !== "") {
        ...
        xhr.open('GET', '/admin/includes/manage_database.php?action=reset&db_name=' + db_name);
...
//     if (db_name !== "") {
//         const xhr = new XMLHttpRequest();
//         xhr.open('GET', '/admin/includes/manage_database.php?action=create&db_name=' + db_name);
//         xhr.addEventListener('readystatechange', function () {
//             if (xhr.readyState === XMLHttpRequest.DONE) {
