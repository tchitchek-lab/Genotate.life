...
<script src="/admin/js/manage_references.js?v=612656" xmlns:right></script>
...
<div class="div-border">
    ...
    <table class='manage_tables' style='width: 100%;'>
        ...
        while ($row = mysqli_fetch_array($results, MYSQLI_ASSOC)) {
            ...
            $size = $row ['size'];
            $state = $row ['status'];
            echo "<form name='fasta_$analysis_id' id='fasta_$analysis_id' action='/admin/includes/download_files.php' method='post' target=\"_blank\">";
            ...
            echo "<a href='/admin/index.php?page=manage_reference_details&analysis_id=$analysis_id'><button style='width:30px;height:30px;padding:5px;' data-toggle='tooltip' data-placement='top' title='get details about the homology reference dataset' class='btn btn-md btn-primary'>";
