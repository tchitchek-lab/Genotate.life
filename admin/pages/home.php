...
<div class="div-border" style='width: 100%;'>
    <div style='width: 100%; margin-top: 2px;'>
        <div style='min-width: 209px; width:50%;padding: 2px;' data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="/admin/index.php?page=manage_annotations" class='btn btn-primary'>
        ...
        <div style='min-width: 209px; width:50%;padding: 2px;' data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="/admin/index.php?page=manage_references" class='btn btn-primary'>
                <img src="/img/database.svg" style='height: 30px; filter: invert(90%);'>
        ...
        <div style='min-width: 209px; width:50%;padding: 2px;' data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="/admin/index.php?page=create_reference" class='btn btn-primary'>
        ...
        <div style='min-width: 209px; width:50%;padding: 2px;' data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="/admin/index.php?page=import_references" class='btn btn-primary'>
        ...
        <div style='min-width: 209px; width:50%;padding: 2px;' data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="/admin/index.php?page=configure_database" class='btn btn-primary'>
        ...
        <div style='min-width: 209px; width:50%;padding: 2px;' data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="/admin/index.php?page=configure_platform" class='btn btn-primary'>
                <img src="/img/config.svg" style='height: 30px; filter: invert(90%);'>
