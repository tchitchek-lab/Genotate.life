...
include($_SERVER['DOCUMENT_ROOT'] . "/includes/services_info.php");
?>
...
<div style='width: 420px; margin: 0; padding: 0 0 5px;height: 300px;'>
    ...
    <div class="div-border" style='padding: 5px; height: 260px;'>
        <div style="width: 100%;">
            ...
            <div style="float:right;">
                ...
                <button data-toggle="tooltip" data-placement="top"
                        title="<?php echo $tooltip_text['code_vert_mito']; ?>" class='btn btn-sm btn-secondary'
        ...
        <div style="width: 100%; padding: 0; margin: 0 0 5px;">
			<span data-toggle="tooltip" data-placement="top" title="<?php echo $tooltip_text['compute_ncRNA']; ?>"
                  style="width: 50%; float: left;"> <label data-toggle='buttons' class='btn btn-default active'
...
<div style='width: 420px; margin: 0; padding: 0 5px 5px 0;height: 310px;'>
    ...
    <div class="div-border" style='padding: 5px; height: 270px;'>
        <div style='width: 100%; height: 260px; overflow: auto; overflow-y: scroll;'>
            <?php
            $request = "SELECT * FROM reference WHERE status = 'complete' ORDER BY name";
        ...
        <div id='functional_services_container' style='width: 100%; height: 260px; overflow: auto; overflow-y: scroll;'>
            ...
            foreach ($services_info as $service => $info_service) {
                if (substr_count($service, "BLAST") == 0) {
                    ...
                    echo "<input type=\"checkbox\" name='SERVICE[]' id='$key' value='$key' style='display:none;'>$key</label>";
